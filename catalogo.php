    ...
    <div class="container mt-5">
        <div class="d-flex flex-wrap gap-3 justify-content-center">
            <?php foreach ($categorias as $categoria): ?>
                <a href="catalogo.php?categoria=<?= urldecode($categoria['id_categoria']) ?>" class="btn btn-categoria d-flex align-items-center gap-2 text-decoration-none" role="button" style="width: 240px;"> 
    ...
    <div class="container">
                                ...
                                <div class="card h-100 text-center">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="agregar_carrito.php" method="POST">
                                            ...
                                            <button type="submit" class="btn" style="background-color: #9D7AC0; color: white;">Añadir al carrito</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
        ...
        <?php else: ?>
            <?php if (!empty($productos)): ?>
                <div class="mb-5">
                    <h3 class="text-end"><?= htmlspecialchars($productos[0]['nombre_categoria']) ?></h3>
                    <hr>
                    <div class="row g-4">
